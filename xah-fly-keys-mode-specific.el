...
(progn
  ...
  (define-key isearch-mode-map (kbd "M-6") 'isearch-yank-pop)
 )
...
(progn
  (define-key messages-buffer-mode-map "1" nil)
  ...
  (define-key messages-buffer-mode-map "5" nil)
  (define-key messages-buffer-mode-map "6" nil)
